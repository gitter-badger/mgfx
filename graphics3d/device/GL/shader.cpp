...
uint32_t LoadShaders(const char * vertex_file_path, const char * fragment_file_path)
{
    // Create the shaders
    ...
    auto VertexShaderCode = ReadFile(vertex_file_path);
    ...
    auto FragmentShaderCode = ReadFile(fragment_file_path);
